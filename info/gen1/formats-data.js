...
let BattleFormatsData = {
  ...
  psyduck: {
    ...
    eventPokemon: [{ generation: 1, level: 15, moves: ["scratch", "amnesia"] }],
    tier: "LC"
  },
  golduck: {
    randomBattleMoves: ["blizzard", "amnesia"],
  ...
  magikarp: {
    ...
    eventPokemon: [{ generation: 1, level: 5, moves: ["dragonrage"] }],
    tier: "LC"
  },
  gyarados: {
  ...
  mew: {
    ...
    eventPokemon: [{ generation: 1, level: 5, moves: ["pound"] }],
    eventOnly: true,
    tier: "Uber"
  }
};
